  ...
  return (
    <>
      <div style={{ background: "#fef3f2", height: "calc(100vh - 90px)" }}>
        <h1 style={{ margin: "0 0 20px 0", color: "#000", fontWeight: "600", padding: "20px" }}>Contact US (Chicago Art)</h1>
          ...
          >
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              ...
              <div style={{ width: "83%", textAlign: "left" }}>
                ...
                />
                <div
                  className="error d-flex text-danger"
            ...
            <div>
              <button
                disabled={
                  !formError?.email && !formError?.comment && formData.email && formData.name && formData.comment
                    ? false
                    : true
                }
                style={{
